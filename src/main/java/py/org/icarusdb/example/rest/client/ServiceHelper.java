...
public abstract class ServiceHelper
{
    ...
    private Map<String, String> connInfo = new HashMap<String, String>();

    public abstract String getConnInfo(String key);
    
    protected Map<String, String> getConnInfo()
    {
        return connInfo;
    }
    ...
    {
        connInfo.put(key, value);
    }
    
    public void addConnConfigParamater(Map<String, String> parameters)
    {
        connInfo.putAll(parameters);
    }

    public void addConnConfigParamater(IDBProperties parameters)
    {
