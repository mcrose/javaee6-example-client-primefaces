 ...
 *
 */
@FacesConverter(forClass=StateDTO.class)
public class StateConverter extends EntityConverter implements Converter
{
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value)
    {
        ...
        return getViewMap(context).get(value+StateDTO.class.getName());
    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object object)
    {
        ...
        StateDTO entity = null;
        try
        {
            entity = (StateDTO) object;
            Long id = entity.getId();
            if (id != null)
            {
                getViewMap(context).put(id.toString()+StateDTO.class.getName(), object);
